...
exports.getDBConnectionURL = function (obj, noPrefix) {
	var r = (process.env.MONGODB_URL || process.env.OPENSHIFT_MONGODB_DB_URL) ? [process.env.MONGODB_URL || process.env.OPENSHIFT_MONGODB_DB_URL, obj.dbname].join('') : obj.url;
	if (!r) {
